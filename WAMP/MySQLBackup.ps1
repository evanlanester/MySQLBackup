...
#ServerPaths Config#######################################
$errorLogPath = "C:\MySQLBackups\wamp64\"
$backupfolder = "C:\MySQLBackups\wamp64\"
$netbackupfolder = "\\192.168.x.x\<folder>"
$mysqldumpexe = "C:\wamp64\bin\mysql\mysql5.7.18\bin\mysqldump.exe"
$datafolder = "C:\wamp64\bin\mysql\mysql5.7.18\data"
...
###Copy FullBackup to Remote Storage
  Start-BitsTransfer -Source "$($backupfolder)FullBackup.$($today).zip" -Destination "$netbackupfolder" -Description "WAMP MySQLBackup" -DisplayName "WAMP MySQLBackup"
